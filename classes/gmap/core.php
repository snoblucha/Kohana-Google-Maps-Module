...
// function
     ...
     * @return Gmap_Core
     */
    public function type(Gmap_Maptype $mapType)
    {
        $this->type = $mapType;
        return $this;
    }
     ...
     * @return Gmap
     */
    public function marker(Gmap_Marker $marker)
    {
...
// function
    ...
    protected static function validate_control_maptype($maptype)
    {
        ...
        {
            throw new Kohana_Exception('Given Map-Type ":maptype" control is not valid.', array(':maptype' => $maptype));
        } // if
...
// function
    ...
    protected static function validate_control_navigation($navigation)
    {
        ...
        {
            throw new Kohana_Exception('Given Navigation-control ":navigation" is not valid.', array(':navigation' => $navigation));
        } // if
...
// function
    ...
    protected static function validate_control_position($position = NULL)
    {
        ...
        {
            throw new Kohana_Exception('":position" is no supported position.', array(':position' => $position));
        } // if
